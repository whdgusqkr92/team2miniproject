...
public class FinalTurn extends JPanel{
		...
		public FinalTurn(JFrame mf, CharacterDTO characterDTO, InventoryDTO inventoryDTO) {
			this.mf = mf;
			this.mainpanel = this;
		...
		public void paintComponent(Graphics g) {
			...
			Image bossface = new ImageIcon("images/text/Bossface_F.png").getImage().getScaledInstance(200, 180, 0);
